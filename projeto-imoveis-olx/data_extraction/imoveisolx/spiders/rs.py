...
class AdsSpider(scrapy.Spider):
    ...
    start_urls = ['https://rs.olx.com.br/imoveis/venda', 'https://rs.olx.com.br/imoveis/aluguel']
...
def run():
    process = CrawlerProcess({'FEED_EXPORT_ENCODING': 'UTF-8',
                              'FEED_URI': 'file:/c/Users/Admin/Documents/Data_Science/data-science-projects/projeto-imoveis-olx/data_extraction/imoveisolx/output/rs_extract.json',
