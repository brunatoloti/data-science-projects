...
class AdsSpider(scrapy.Spider):
    ...
    start_urls = ['https://rn.olx.com.br/imoveis/venda', 'https://rn.olx.com.br/imoveis/aluguel']
...
def run():
    process = CrawlerProcess({'FEED_EXPORT_ENCODING': 'UTF-8',
                              'FEED_URI': 'file:/c/Users/Admin/Documents/Data_Science/data-science-projects/projeto-imoveis-olx/data_extraction/imoveisolx/output/rn_extract.json',
